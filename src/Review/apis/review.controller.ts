...
export class ReviewController {
  ...
  @Put(':id')
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Cập nhật đánh giá của bạn' })
  async updateReview(
    @Param('id') id: string,
  ...
  async deleteReview(
    ...
    await this.deleteReviewAction.execute(userId, id);
    return new SuccessResponseDto('Xóa đánh giá thành công', null);
  }
}
